...
longintud = len(
    diccionario
)  # Nos indica la cantidad de claves-valor que tiene el diccionario
contructorDiccionario = dict(
    nombre="Sergie Code", youtube="www.youtube.com/@sergiecode"
)  # Se puede crear con constructor
...
values = (
    diccionario.values()
)  # el tipo de dato que devuelve se llama <class 'dict_values'>

items = (
    diccionario.items()
)  # nos devuelve tuplas de clave-valor en una lista // <class 'dict_items'>
...
diccionario.update(
    {
        "direccion": {"calle": "Liverpool Street", "numero": 123, "ciudad": "Londres"},
    }
)
...
hijo1 = {"nombre": "Pedro", "edad": 5}
hijo2 = {"nombre": "Alan", "edad": 7}
hijo3 = {"nombre": "Enzo", "edad": 9}
