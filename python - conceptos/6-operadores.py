...
tramite = (
    edad >= 18 and edad <= 65
)  ## Devuelve True si cumplimos las las 2 condiciones dadas
semaforo = "Rojo"
cruzar = (
    semaforo == "Verde" or semaforo == "Amarillo"
)  # Devuelve True si cumplimos al menos una de las dos condiciones
verdad = True
